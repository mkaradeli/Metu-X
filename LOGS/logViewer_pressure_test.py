...
ax[0].plot(myLog.df["timestamp"], myLog.df["pressure_demand_0"],'-.', label="Nozzle demand")
ax[0].plot(myLog.df["timestamp"], myLog.df["pressure_demand_1"],'-.', label="Nozzle demand")
ax[0].plot(myLog.df["timestamp"], myLog.df["pressure_demand_2"],'-.', label="Nozzle demand")
ax[0].plot(myLog.df["timestamp"], myLog.df["pressure_demand_3"],'-.', label="Nozzle demand")
# pressure_demand
