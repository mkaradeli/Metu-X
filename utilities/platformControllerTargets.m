...
platform_targets.V_td = 0.3; % m/s 0.4
platform_targets.h_cut   = 0.1; % m 0.3
platform_targets.h_blend = 1; % m


platform_targets.a_dec =3.7; %11.3
% platform_targets.a_dec_high = 15; % m/s2
platform_targets.a_dec_low = 5; % m/s2


platform_targets.V_max = 5; % m/s
...
platform_targets.altitude.kI = 24.6 ;%9.8^2/3
